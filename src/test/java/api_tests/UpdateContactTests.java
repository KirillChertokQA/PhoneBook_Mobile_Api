...
public class UpdateContactTests extends ContactController {
    ...
    public void updateContactPositiveTest(){
        ...
        ContactDtoLombok contact = ContactDtoLombok.builder()
                ...
                .lastName("new_last_name"+generateString(5))
                .email("new_mail"+generateEmail(7))
                .phone("1234567890")
                .address("new_address"+generateString(5))
                .description("new_desc")
                .build();
        Response response = updateContactResponseWithToken(contact);
        softAssert.assertEquals(response.getStatusCode(), 200);
       softAssert.assertTrue(getUserContactsResponse(tokenDto.getToken()).as(ContactsDto.class)
    ...
    public void updateContactNegativeTest_wrongToken401(){
        ...
        ContactDtoLombok contact = ContactDtoLombok.builder()
                ...
                .description("new_desc")
                .build();
        Response response = updateContactResponse(contact, "string_token");
